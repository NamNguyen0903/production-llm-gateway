...
| AI-102 | Design system architecture | Must | Review | Day 2 |
| AI-103 | Define API contract and errors | Must | Review | Day 2 |
| AI-104 | Design database schema | Must | Review | Day 2 |
